...
class FreeplayState extends MusicBeatState
{
	...
	private var AllPossibleSongs:Array<String> = ["bambi", "goofy ahh"];
	...
	public function LoadProperPack()
		{
			switch (AllPossibleSongs[CurrentPack].toLowerCase())
			{
				case 'bambi':
					...
					addWeek(['Stop', 'The Phone', 'Indignancy'], 1, ['bambi-pissed']);
					addWeek(['Get Out'], 1, ['bambi-mad']);
					addWeek(['Overthink', 'Reality Breaking'], 1, ['bambi-garcello']);
			}
		}
