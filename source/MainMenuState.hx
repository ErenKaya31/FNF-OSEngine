...
class MainMenuState extends MusicBeatState
{
	...
	public static var painEditionVersion:String = '1.5'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(FlxG.width * 0.7, FlxG.height - 44, 0, "Pain Edition v" + painEditionVersion, 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
